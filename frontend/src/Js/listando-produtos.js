...
export async function CarregaProdutos(){    
    ...
    let editItem = document.querySelector(".background_popup")
    ...
    if(dados.length == 0){
        ...
        linha.insertCell(0).innerHTML = "Não há dados";
        linha.insertCell(1).innerHTML = "N/D";
        linha.insertCell(2).innerHTML = "N/D";
    }else{        
    spinner.style.display = "none";
